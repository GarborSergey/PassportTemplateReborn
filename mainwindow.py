...
"border: none;")
        ...
        self.lablePanelAssignment = QtWidgets.QLabel(parent=self.frame)
        font = QtGui.QFont()
        font.setFamily("MADE Likes Slab")
        font.setPointSize(14)
        self.lablePanelAssignment.setFont(font)
        self.lablePanelAssignment.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.lablePanelAssignment.setTextFormat(QtCore.Qt.TextFormat.AutoText)
        self.lablePanelAssignment.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.lablePanelAssignment.setObjectName("lablePanelAssignment")
        self.horizontalLayout_6.addWidget(self.lablePanelAssignment)
        ...
        self.lablePurposeOfTheIntroductoryControlUnit = QtWidgets.QLabel(parent=self.frame)
        font = QtGui.QFont()
        font.setFamily("MADE Likes Slab")
        font.setPointSize(14)
        self.lablePurposeOfTheIntroductoryControlUnit.setFont(font)
        self.lablePurposeOfTheIntroductoryControlUnit.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.lablePurposeOfTheIntroductoryControlUnit.setTextFormat(QtCore.Qt.TextFormat.AutoText)
        self.lablePurposeOfTheIntroductoryControlUnit.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.lablePurposeOfTheIntroductoryControlUnit.setObjectName("lablePurposeOfTheIntroductoryControlUnit")
        self.horizontalLayout_5.addWidget(self.lablePurposeOfTheIntroductoryControlUnit)
        ...
        self.lableAdditionalEquipment = QtWidgets.QLabel(parent=self.frame)
        font = QtGui.QFont()
        font.setFamily("MADE Likes Slab")
        font.setPointSize(14)
        self.lableAdditionalEquipment.setFont(font)
        self.lableAdditionalEquipment.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.lableAdditionalEquipment.setTextFormat(QtCore.Qt.TextFormat.AutoText)
        self.lableAdditionalEquipment.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.lableAdditionalEquipment.setObjectName("lableAdditionalEquipment")
        self.horizontalLayout_4.addWidget(self.lableAdditionalEquipment)
        ...
        self.lableProtectiveDevices = QtWidgets.QLabel(parent=self.frame)
        font = QtGui.QFont()
        font.setFamily("MADE Likes Slab")
        font.setPointSize(14)
        self.lableProtectiveDevices.setFont(font)
        self.lableProtectiveDevices.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.lableProtectiveDevices.setTextFormat(QtCore.Qt.TextFormat.AutoText)
        self.lableProtectiveDevices.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.lableProtectiveDevices.setObjectName("lableProtectiveDevices")
        self.horizontalLayout_3.addWidget(self.lableProtectiveDevices)
        ...
        self.lableIngressProtectionRating = QtWidgets.QLabel(parent=self.frame)
        font = QtGui.QFont()
        font.setFamily("MADE Likes Slab")
        font.setPointSize(14)
        self.lableIngressProtectionRating.setFont(font)
        self.lableIngressProtectionRating.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.lableIngressProtectionRating.setTextFormat(QtCore.Qt.TextFormat.AutoText)
        self.lableIngressProtectionRating.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.lableIngressProtectionRating.setObjectName("lableIngressProtectionRating")
        self.horizontalLayout_2.addWidget(self.lableIngressProtectionRating)
...
"border: none;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lablePanelAssignment.setText(_translate("MainWindow", "Назначение панели "))
        self.lablePurposeOfTheIntroductoryControlUnit.setText(_translate("MainWindow", "Назначение вводного аппарата управления "))
        self.lableAdditionalEquipment.setText(_translate("MainWindow", "Наличие дополнительного оборудования "))
        self.lableProtectiveDevices.setText(_translate("MainWindow", "Защитные аппараты на отходящих линиях "))
        self.lableIngressProtectionRating.setText(_translate("MainWindow", "Степень защиты IP "))
